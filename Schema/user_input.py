...
class UserInput(BaseModel):
    ...
    city: Annotated[Literal['Bangalore', 'Chennai', 'Delhi', 'Hyderabad', 'Kolkata', 'Mumbai', 'Pune'],
                    Field(..., description='city of the user')]
    occupation: Annotated[Literal['Engineer', 'Doctor', 'Teacher', 'Lawyer','Artist', 'Business', 'Farmer', 'Student'],
